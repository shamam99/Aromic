...
struct OnboardingView: View {
    ...
    @State private var navigateToLogin = false // ✅ Added navigation state
    ...
    let pages = [
        ...
        OnboardingPageData(
            ...
            description: "By discovering a scent that truly represents who you are using AI",
    ...
    var body: some View {
        if navigateToLogin {
            ContentView() // ✅ Navigate to Login Page
        } else {
            VStack {
                    ...
                    if currentPage < pages.count - 1 {
                        ...
                        Button(action: {
                            ...
                            Image(systemName: "arrow.right")
                                ...
                                .padding(12)
                                .background(Circle().strokeBorder(Color("babypink"), lineWidth: 5))
                                .frame(width: 40, height: 40)
                                .foregroundColor(.white)
                        }
                        .padding(.trailing, 20)
                    } else {
                        // ✅ Last Page → Finish Onboarding & Move to Login
                        Button(action: {
                            UserDefaults.standard.set(true, forKey: "hasSeenOnboarding") // ✅ Store completion
